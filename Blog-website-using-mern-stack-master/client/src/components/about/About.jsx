    ...
    return (
        <Box>
            ...
            <Wrapper>
                ...
                <Text variant="h5">I'm Aparna Mohanty, a final-year BTech Computer Science student at Sharda University. <br/>
                I specialize in web development, with strong skills in React and Node.js.
                 ...
                 I'm eager to grow in the tech industry and make a meaningful impact.
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/aparna162" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
                    ...
                    <Box component="span" style={{ marginLeft: 10 , marginRight: 10}}>
                        or send me an Email 
                        <Link href="mailto:mohantyaparna41@gmail.com?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                    </Box>
                </Text>
